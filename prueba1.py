...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.plot_example(comedores=[], nacerCom="cerca del centro")
    ...
    def update_comedores(self, index):
        ...
        self.plot_example(comedores=comedores, nacerCom=nacer_com)
    ...
    def plot_example(self, comedores, nacerCom):
        # Limpiamos la figura
        self.figure.clear()
        ...
        # Mostrar comedores y plantas en la gráfica
        plantas = [(1, 1), (6, 2), (9, 8)]    # Coordenadas de las plantas (x, y)
